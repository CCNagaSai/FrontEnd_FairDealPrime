...
function UserBetHistory({ data }) {
      ...
      if (data != undefined && data.betObjectData.length > 0) {
        ...
        for (let i = 0; i <= data.betObjectData.length - 1; i++) {
          if (data.betObjectData[i].type != undefined) {
            datajson[data.betObjectData[i].betIndex] =
              datajson[data.betObjectData[i].betIndex] != undefined
                ? datajson[data.betObjectData[i].betIndex] +
                  data.betObjectData[i].bet
                : data.betObjectData[i].bet;
          }
        }
  ...
  console.log("data.betObjectData", data.betObjectData);
          ...
          <table className="roulette-table">
            <tr>
              <td
                ...
                data-number="0"
              >
                <p className="Chipsbet">{betinfo["0"]}</p> 0{" "}
                <button className="number50">{betinfo["50"]}</button>{" "}
                <button className="number49">{betinfo["49"]}</button>{" "}
                <button className="number51">{betinfo["51"]}</button>{" "}
                <button className="number131">{betinfo["131"]}</button>{" "}
                <button className="number132">{betinfo["132"]}</button>{" "}
              </td>
              <td className="red" data-bet="number" data-number="3">
                <p className="Chipsbet">{betinfo["3"]}</p>3{" "}
              ...
              <td className="black" data-bet="number" data-number="6">
                <p className="Chipsbet">{betinfo["6"]}</p>6{" "}
              ...
              <td className="red" data-bet="number" data-number="9">
                <p className="Chipsbet">{betinfo["9"]}</p>9{" "}
              ...
              <td className="red" data-bet="number" data-number="21">
                <p className="Chipsbet">{betinfo["21"]}</p>21{" "}
              ...
              <td className="black" data-bet="number" data-number="24">
                <p className="Chipsbet">{betinfo["24"]}</p>24{" "}
              ...
              <td className="red" data-bet="number" data-number="27">
                <p className="Chipsbet">{betinfo["27"]}</p>27{" "}
              ...
              <td className="first-dozen" data-bet="number" data-number="C3">
                <p className="Chipsbet">{betinfo["39"]}</p>C3
              </td>
            </tr>

            <tr>
              <td className="black" data-bet="number" data-number="2">
                <p className="Chipsbet">{betinfo["2"]}</p>2{" "}
              ...
              <td className="red" data-bet="number" data-number="5">
                <p className="Chipsbet">{betinfo["5"]}</p>5{" "}
                <button className="number64">{betinfo["64"]}</button>{" "}
                <button className="number98">{betinfo["98"]}</button>{" "}
                <button className="number121">{betinfo["121"]}</button>{" "}
              </td>
              <td className="black" data-bet="number" data-number="8">
                <p className="Chipsbet">{betinfo["8"]}</p>8{" "}
                <button className="number65">{betinfo["65"]}</button>{" "}
              ...
              <td className="black" data-bet="number" data-number="17">
                ...
                <button className="number125">{betinfo["125"]}</button>
              </td>
              <td className="black" data-bet="number" data-number="20">
                <p className="Chipsbet">{betinfo["20"]}</p>20{" "}
                <button className="number69">{betinfo["69"]}</button>{" "}
                <button className="number103">{betinfo["103"]}</button>
                <button className="number126">{betinfo["126"]}</button>
              </td>
              <td className="red" data-bet="number" data-number="23">
                <p className="Chipsbet">{betinfo["23"]}</p>23{" "}
                <button className="number70">{betinfo["70"]}</button>{" "}
                <button className="number104">{betinfo["104"]}</button>
                <button className="number127">{betinfo["127"]}</button>{" "}
              </td>
              <td className="black" data-bet="number" data-number="26">
                <p className="Chipsbet">{betinfo["26"]}</p>26{" "}
                <button className="number71">{betinfo["71"]}</button>{" "}
              ...
              <td className="first-dozen" data-bet="number" data-number="C2">
                <p className="Chipsbet">{betinfo["38"]}</p>C2
              </td>
            </tr>
            <tr>
              <td className="red" data-bet="number" data-number="1">
                <p className="Chipsbet">{betinfo["1"]}</p>1{" "}
              ...
              <td className="black" data-bet="number" data-number="4">
                <p className="Chipsbet">{betinfo["4"]}</p>4{" "}
              ...
              <td className="red" data-bet="number" data-number="7">
                <p className="Chipsbet">{betinfo["7"]}</p> 7{" "}
              ...
              <td className="black" data-bet="number" data-number="10">
                <p className="Chipsbet">{betinfo["10"]}</p>10{" "}
              ...
              <td className="red" data-bet="number" data-number="19">
                <p className="Chipsbet">{betinfo["19"]}</p>19{" "}
              ...
              <td className="black" data-bet="number" data-number="22">
                <p className="Chipsbet">{betinfo["22"]}</p>22{" "}
              ...
              <td className="red" data-bet="number" data-number="25">
                <p className="Chipsbet">{betinfo["25"]}</p>25{" "}
              ...
              <td className="black" data-bet="number" data-number="28">
                <p className="Chipsbet">{betinfo["28"]}</p>28{" "}
              ...
              <td className="first-dozen" data-bet="number" data-number="C1">
                <p className="Chipsbet">{betinfo["37"]}</p>C1
              </td>
            </tr>
            <tr>
              <td></td>
              <td colSpan={4} className="first-dozen" data-bet="first-dozen">
                <p className="Chipsbet">{betinfo["40"]}</p>1st 12
              </td>
              <td colSpan={4} className="second-dozen" data-bet="second-dozen">
                <p className="Chipsbet">{betinfo["41"]}</p>2nd 12
              </td>
              <td colSpan={4} className="third-dozen" data-bet="third-dozen">
                <p className="Chipsbet">{betinfo["42"]}</p>3rd 12
              </td>
            </tr>
            <tr>
              <td></td>
              <td colSpan={2} className="low" data-bet="low">
                <p className="Chipsbet">{betinfo["43"]}</p>1-18
              </td>
              <td colSpan={2} className="even" data-bet="even">
                <p className="Chipsbet">{betinfo["46"]}</p>Even
              </td>

              <td colSpan={2} className="red" data-bet="red">
                <p className="Chipsbet">{betinfo["47"]}</p>Red
              </td>
              <td colSpan={2} className="black" data-bet="black">
                <p className="Chipsbet">{betinfo["48"]}</p>Black
              </td>

              <td colSpan={2} className="odd" data-bet="odd">
                <p className="Chipsbet">{betinfo["45"]}</p>Odd
              </td>
              <td colSpan={2} className="high" data-bet="high">
                <p className="Chipsbet">{betinfo["44"]}</p>19-36
              </td>
            </tr>
          </table>
        </div>
