...
const AGameHistory = () => {
  const [filteredData, setFilteredData] = useState(Array.isArray(mData) ? mData : []);
    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <h2 className="text-blue-600 text-[18px] ml-1 md:text-xl font-bold mb-6 border-b border-blue-500 pb-3 ">
          ...
          {/* Render the backend data table */}
          <div className="overflow-x-auto mt-8">
            <h3 className="text-blue-600 text-lg font-bold mb-4">Backend Data</h3>
            <FormTable
              data={backendData}
              showPagination={true}
              columns={columns}
              showTotals={false} // Adjust based on your requirements
            />
          </div>
        </div>
      </div>
