...
const Reportpointfile = () => {
  ...
  const handleClear = () => {
    ...
    setShowTable(false); // Hide the table when clearing the filters
  };
  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row">
        {/* <div className="flex-none w-full sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/5 pr-2">
          <Sidebar />
        </div> */}

        <div className="flex-1 ml-[4px] mr-[4px] md:max-w-[1100px] mx-auto border border-blue-500 p-[5px]">
          <h2 className="text-blue-600 text-[18px] ml-1 md:text-xl font-bold mb-6 border-b border-blue-500 pb-3 ">Ledger</h2>

          {/* Filter Form */}
          <div className="bg-[#e6ebff] p-5 rounded-lg shadow-lg m-1 sm:m-3">
            <form className="flex flex-col items-center" onSubmit={handleSubmit}>
              {/* First row: Receive By and Sent By */}
              ...
              <div div className="flex flex-col sm:flex-row justify-between sm:space-x-4 mb-5  w-full">
                <div className="flex-1 mb-4 s">
          ...
          {showTable && (
            <div className="overflow-x-auto mt-6 ">
              <FormTable
                ...
                columns={columns}
                showPagination={true}
                showTotalInOut={true} // Show totals
              />
            </div>
          )}
        </div>
...
export default Reportpointfile;
