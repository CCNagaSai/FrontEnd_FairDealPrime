...
import "../../Agent/AgentChangePassword/AgentChangePassword.css";

import Cookies from "universal-cookie";
const cookies = new Cookies();
const API_URL = import.meta.env.VITE_HOST_URL;

const IshankChangeSubAgentPassword = () => {
  ...
  useEffect(() => {
    // Get SubagentId and token from cookies
    ...
    if (storedAgentId) {
      setAgentId(storedAgentId); // Set the SubagentId in state
    } else {
...
export default IshankChangeSubAgentPassword;
